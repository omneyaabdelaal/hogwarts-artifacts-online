...
class WizardControllerTest {
    ...
    void testFindWizardByIdNotFound() throws Exception {
        //given
        given(wizardService.findById(1L)).willThrow(new WizardNotFoundException(1L));
        ...
        mockMvc.perform(get("/api/v1/wizards/1").accept(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$.message").value("Wizard with id 1 not found :("))
    ...
    void testUpdateWizardSuccess() throws Exception {
        ...
        mockMvc.perform(put("/api/v1/wizards/1").contentType(MediaType.APPLICATION_JSON).content(json).accept(MediaType.APPLICATION_JSON))
                .andExpect( jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
    ...
    void testUpdateWizardFailure() throws Exception {
        ...
        //when and then
        given(wizardService.update(Mockito.any(Long.class),Mockito.any(Wizard.class))).willThrow(new WizardNotFoundException(1L));
    ...
    void testDeleteWizardSuccess() throws Exception {
        ...
        //when and then
        mockMvc.perform(delete("/api/v1/wizards/1").contentType(MediaType.APPLICATION_JSON))
                .andExpect( jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
    ...
    void testDeleteWizardFailure() throws Exception {
        ...
        //given
        doThrow(
                new WizardNotFoundException(1L))
